...
export type OrderStatus = 'Ingresado' | 'Presupuestado' | 'En Reparación' | 'Finalizado' | 'Cerrado';
...
let mockOrders: Order[] = [
  ...
  },
  {
    ...
    costoManoObra: 85000,
    repuestos: [
      { id: 'r1', nombre: 'Kit Correa Distribución', costo: 120000, cantidad: 1 },
      { id: 'r2', nombre: 'Bomba de agua', costo: 45000, cantidad: 1 }
    ],
  ...
  },
  {
    ...
    costoManoObra: 35000,
    repuestos: [
      { id: 'r3', nombre: 'Junta de cárter', costo: 15000, cantidad: 1 },
      { id: 'r4', nombre: 'Aceite 10W40 4L', costo: 28000, cantidad: 1 }
    ],
...
export const mockDbService = {
  ...
  addRepuestoToOrden: (ordenId: string, repuesto: Omit<Part, 'id'>, mecanico: { id: string, nombre: string }) => {
    mockOrders = mockOrders.map(o => {
      if (o.id === ordenId) {
        return {
          ...o,
          mecanicoResponsable: mecanico,
          repuestos: [...o.repuestos, { ...repuesto, id: Math.random().toString(36).substr(2, 9) }]
        };
      }
      return o;
    });
